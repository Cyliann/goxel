...
vec3 raySphereIntersection(vec3 rayOrigin, vec3 rayDirection, float radius) {
    vec3 color = vec3(0);
...
void main() {
    ...
    frag_color = vec4(raySphereIntersection(rayOrigin, rayDirection, .7), 1);
}
